...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='convnext_xlarge_384_in22ft1k')          
    parser.add_argument('--pre_trained', type=str, default='./save_result/models/convnext_xlarge_384_in22ft1k.pth')           
    parser.add_argument('--output_txt', type=str, default='./save_result/pred_convnext_xlarge_384_in22ft1k.txt')    
...
def main():
    ...
    # create model
    model = get_convnext(model_name=args.model_name, num_classes=args.num_class)
